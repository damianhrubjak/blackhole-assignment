<aside id="map-element"
    class="fixed right-0 top-0 z-30 h-[calc(100dvh-5rem)] max-w-md translate-x-full self-stretch p-4 transition duration-300 xl:sticky xl:h-screen xl:max-w-xs xl:translate-x-0 xl:px-0 xl:py-4 2xl:max-w-md">
    <div class="relative h-full w-full shadow-xl xl:shadow-none">
        ...
        <div class="absolute bottom-0 left-0 w-full px-2 py-4">
            <div class="flex h-11 w-full items-stretch justify-stretch gap-2">
                <button class="h-full w-32 rounded-lg bg-pallette-blue-600 px-3 py-1 font-bold text-white">Map</button>
                <button
                    class="h-full w-32 rounded-lg bg-white px-3 py-1 font-bold text-pallette-blue-600">Sattelite</button>
